    ...
    <header class="search-header">
      <div class="header-content">
        ...
        <div class="search-box-container">
          <div class="search-box">
            <input type="text" value="Proyectos y Repositorios de Erick Pérez" readonly />
      ...
      <nav class="search-tabs">
        <div class="tabs-inner">
          ...
          <div class="tab active">Proyectos</div>
          <div class="tab">Repositorios</div>
...
<style scoped>
/* Copiamos los estilos base para mantener la coherencia */
...
.pagination-letters span { width: 26px; text-align: center; }
.pagination-numbers { display: flex; justify-content: center; font-size: 13px; }
.pagination-numbers .num { width: 26px; text-align: center; }
